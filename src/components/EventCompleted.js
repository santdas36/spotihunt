...
function EventCompleted() {
  ...
  return (
    ...
    >
		...
		<motion.h2 initial={initialAnim} animate={animate} transition={{type: 'tween', delay: 1.8}}>Stay Tuned for Results.</motion.h2>
		
		<motion.form initial={initialAnim} animate={animate} transition={{type: 'tween', delay: 2}} onSubmit={sendFeedback}>
		...
		<motion.p initial={{y: '-1rem', opacity: 0}} transition={{type: 'tween', delay: 1.9}} animate={animate} ><span>Hope you had fun! - </span><a href="https://instagram.com/christ.keng">@christ.keng</a></motion.p>
    </motion.div>
  );
}
