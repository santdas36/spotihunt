  ...
  return (
    ...
    >
        ...
        {fbSent ? (
          ...
          <>
            ...
            <textarea
              ...
              rows="3"
              placeholder="Write about your experience, and how it can be improved in the upcoming events..."
            ></textarea>
      ...
      >
        ...
        <a href="https://instagram.com/christ.keng">@christ.keng</a>
      </motion.p>
    </motion.div>
  );
}
